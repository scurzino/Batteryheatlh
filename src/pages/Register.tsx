      ...
      <div className="w-full max-w-xl">
        ...
        <div className="glass-panel ghost-border rounded-2xl p-8">
          ...
          <div className="mt-8 flex justify-between">
            ...
            {step < 3 ? (
              <button disabled={!canAdvance()} onClick={handleNext} className="px-5 py-2.5 bg-primary text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-opacity">Next</button>
            ) : (
              <button disabled={isSubmitting} onClick={handleSubmit} className="px-5 py-2.5 bg-primary text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-opacity">{isSubmitting ? 'Submitting...' : 'Submit to Server'}</button>
            )}
          </div>
        </div>
      </div>
